import { g as j, s as q, a as K, b as Q, t as Z, q as H, _ as p, l as F, c as J, F as X, K as Y, Q as ee, e as te, z as ae, G as re } from "./mermaid.core-BXO_VlFI.js";
import { p as ne } from "./chunk-4BX2VUAB-tIgYch2b.js";
import { p as ie } from "./treemap-KMMF4GRG-DhRkDNon.js";
import { d as I } from "./arc-y4x8g4Cx.js";
import { o as se } from "./ordinal-e--sRYe8.js";
import { a as S, t as z, n as le } from "./string-BnSFgVSn.js";
function oe(e, a) {
...
function ue() {
  ...
  function l(t) {
    var n, c = (t = le(t)).length, d, y, m = 0, u = new Array(c), i = new Array(c), v = +x.apply(this, arguments), w = Math.min(z, Math.max(-z, s.apply(this, arguments) - v)), h, C = Math.min(Math.abs(w) / c, o.apply(this, arguments)), $ = C * (w < 0 ? -1 : 1), g;
    for (n = 0; n < c; ++n)
...
` + e);
  const s = x.db, o = J(), l = X(s.getConfig(), o.pie), t = 40, n = 18, c = 4, d = 450, y = d, m = Y(a), u = m.append("g");
  u.attr("transform", "translate(" + y / 2 + "," + d / 2 + ")");
  const { themeVariables: i } = o;
  let [v] = ee(i.pieOuterStrokeWidth);
  v ??= 2;
  const w = l.textPosition, h = Math.min(y, d) / 2 - t, C = I().innerRadius(0).outerRadius(h), $ = I().innerRadius(h * w).outerRadius(h * w);
  ...
  m.attr("viewBox", `0 0 ${P} ${d}`), te(m, d, P, l.useMaxWidth);
}, "draw"), $e = { draw: Ce }, Fe = {
  parser: ye,
  db: L,
  renderer: $e,
