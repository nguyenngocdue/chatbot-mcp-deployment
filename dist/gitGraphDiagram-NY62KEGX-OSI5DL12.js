import { p as Y } from "./chunk-4BX2VUAB-tIgYch2b.js";
import { I as K } from "./chunk-QZHKN3VN-DdlS0Odd.js";
import { t as U, q as V, s as X, g as J, a as Q, b as Z, _ as l, l as m, d as rr, u as er, E as tr, z as ar, k as C, F as sr, G as nr, H as or, c as cr, I as ir } from "./mermaid.core-BXO_VlFI.js";
import { p as dr } from "./treemap-KMMF4GRG-DhRkDNon.js";
var p = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
  MERGE: 3,
  CHERRY_PICK: 4
}, hr = nr.gitGraph, I = /* @__PURE__ */ l(() => sr({
  ...hr,
  ...or().gitGraph
}), "getConfig"), c = new K(() => {
...
var pr = /* @__PURE__ */ l(function() {
...
}, qr = cr(), v = qr?.gitGraph, L = 10, k = 40, E = 4, T = 2, M = 8, b = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), O = 30, R = /* @__PURE__ */ new Map(), q = [], B = 0, u = "LR", Ar = /* @__PURE__ */ l(() => {
...
}, "findClosestParent"), Hr = /* @__PURE__ */ l((t) => {
  let r = "", s = 1 / 0;
  return t.forEach((n) => {
    const e = w.get(n).y;
    e <= s && (r = n, s = e);
  }), r || void 0;
}, "findClosestParentBT"), _r = /* @__PURE__ */ l((t, r, s) => {
  let n = s, e = s;
  const a = [];
  t.forEach((d) => {
    const o = r.get(d);
  ...
  let h = d.sort(f);
  u === "BT" && (o && _r(h, r, a), h = h.reverse()), h.forEach(($) => {
    const g = r.get($);
    if (!g)
    ...
    const i = Kr(g, a, o);
    if (s) {
      const y = jr(g), x = g.customType ?? g.type, H = b.get(g.branch)?.index ?? 0;
...
`, "id:", r, s), !v)
  ...
  d.forEach((h, $) => {
    ...
    const H = g.getBBox();
    f = Qr(h.name, f, $, H, e), x.remove(), y.remove(), i.remove();
  }), z(o, R, !1), v.showBranches && Jr(o, d), Xr(o, R), z(o, R, !0), er.insertTitle(
    o,
    "gitTitleText",
    v.titleTopMargin ?? 0,
    a.getDiagramTitle()
