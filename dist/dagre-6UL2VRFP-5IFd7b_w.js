import { _ as w, ab as F, ac as Y, ad as _, ae as H, l as i, c as V, af as U, ag as $, a2 as q, a7 as z, a3 as P, a1 as K, ah as Q, ai as W, aj as Z } from "./mermaid.core-v6Q0JMw7.js";
import { i as b, G as B } from "./graph-zeurAGiP.js";
import { l as I } from "./layout-CLANrehU.js";
import { c as L } from "./clone-D7nVW5Si.js";
import { m as A } from "./min-DJlKzC8s.js";
function h(e) {
  var t = {
    options: {
...
Parent cluster`,
      ...
      if (i.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode) {
        ...
        t.children(f).length > 0 ? (i.trace(
          ...
          "Graph:",
          t
        ), i.trace(C(s.id, t)), d.set(s.id, { id: C(s.id, t), node: s })) : (i.trace("Node - the non recursive path XAX", f, X, t.node(f), l), await q(X, t.node(f), { config: o, dir: l }));
    })
