import { g as le } from "./chunk-55IACEB6-BFrLXk3U.js";
import { s as he } from "./chunk-QN33PNHL-dfHvl25W.js";
import { _ as l, l as I, p as de, r as ge, G as B, c as z, i as V, ak as ue, X as pe, Y as fe, $ as ye } from "./mermaid.core-C8MeWhuc.js";
const E = [];
for (let t = 0; t < 256; ++t)
  ...
  var t = /* @__PURE__ */ l(function(x, s, i, o) {
    ...
    parse: /* @__PURE__ */ l(function(s) {
      ...
      for (var G in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, G) && (v.yy[G] = this.yy[G]);
      ...
      for (var _, T, D, $, O = {}, P, k, ie, M; ; ) {
        if (T = o[o.length - 1], this.defaultActions[T] ? D = this.defaultActions[T] : ((_ === null || typeof _ > "u") && (_ = te()), D = w[T] && w[T][_]), typeof D > "u" || !D.length || !D[0]) {
          ...
          y.showPosition ? H = "Parse error on line " + (U + 1) + `:
` + y.showPosition() + `
Expecting ` + M.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : H = "Parse error on line " + (U + 1) + ": Unexpected " + (_ == ee ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(H, {
            text: y.match,
        ...
        switch (D[0]) {
          case 1:
            o.push(_), g.push(y.yytext), r.push(y.yylloc), o.push(D[1]), _ = null, Z = y.yyleng, d = y.yytext, U = y.yylineno, j = y.yylloc;
            break;
          case 2:
