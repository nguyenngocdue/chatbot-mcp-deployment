import { g as oe } from "./chunk-FMBD7UC4-GfrOBHWo.js";
import { _ as d, H as rt, d as O, e as he, l as L, z as de, B as ge, a4 as ue, c as R, R as pe, a5 as j, a6 as Wt, a7 as fe, u as $, k as xe, a8 as ye, a9 as xt, i as yt, aa as be } from "./mermaid.core-BXO_VlFI.js";
import { c as we } from "./clone-BB0ku_we.js";
import { G as me } from "./graph-AjkVv7YK.js";
import { c as Le } from "./channel-keeEPOue.js";
import { l as Se, k as ke } from "./string-BnSFgVSn.js";
var bt = (function() {
...
bt.parser = bt;
var ve = bt, X = /* @__PURE__ */ new Map(), kt = [], wt = /* @__PURE__ */ new Map(), Bt = "color", Ct = "fill", Ee = "bgFill", Pt = ",", _e = R(), ct = /* @__PURE__ */ new Map(), De = /* @__PURE__ */ d((e) => xe.sanitizeText(e, _e), "sanitizeText"), Ne = /* @__PURE__ */ d(function(e, t = "") {
  let a = ct.get(e);
...
var It = 0, Ie = /* @__PURE__ */ d(() => (It++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + It), "generateId"), Oe = /* @__PURE__ */ d((e) => {
  ...
  const a = Le, i = a(e, "r"), l = a(e, "g"), s = a(e, "b");
  return ge(i, l, s, t);
...
var or = /* @__PURE__ */ d((e, t) => {
  ...
  const i = R(), { subGraphTitleTotalMargin: l } = fe(i);
  if (e.label) {
    const s = Lt[e.id];
    let r = e.x, n = e.y;
    if (a) {
  ...
  const { x: b, y: S } = ue(a), v = Se().x(b).y(S).curve(w);
  let k;
  switch (a.thickness) {
    case "normal":
  ...
  let _ = "";
  (R().flowchart.arrowMarkerAbsolute || R().state.arrowMarkerAbsolute) && (_ = pe(!0)), nr(B, a, _, r, l);
  let D = {};
...
function Dt(e, t, a = !1) {
  ...
  const c = be(i?.styles ?? []), u = i.label, o = i.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return {
