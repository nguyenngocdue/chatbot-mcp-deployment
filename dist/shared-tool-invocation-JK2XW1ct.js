import { i as Hr, h as J, r as q, f as ee, R as E, k as cg, l as lg, j as fe, m as ut } from "./embed-CPPPUHc1.js";
import { w as kh, n as Lh, a as oe, M as ac, S as fg, T as pg, l as Fh, t as $n, b as Ce, p as Yu, s as rn, c as Wh, F as dg, G as vg, H as hg, I as yg, J as mg, K as gg, L as bg, N as Og, O as wg, k as xg, P as Sg, Q as Ag } from "./string-BnSFgVSn.js";
import { b as Zu, p as sr } from "./band-DjWPbnU2.js";
import { b as nn, n as Pg, d as _g, i as ic, e as Ju, f as yt, t as oc, a as uc, g as Hc, h as We, c as Eg, j as Rn, k as zh, l as Qu, m as Tg } from "./linear-GcbIgsgU.js";
import { i as Je, a as Ge } from "./init-DxzjmxYy.js";
import { n as jg, o as Ig, u as Mg, s as Cg, p as $g, q as Rg, r as Dg, v as qg, w as Ng, x as Bg, y as kg, z as Lg, t as Fg } from "./time-BXSOxX-S.js";
...
var Xl;
function _b() {
  return Xl || (Xl = 1, si.exports = Pb()), si.exports;
}
var Eb = _b(), ci, Vl;
function Yh() {
  if (Vl) return ci;
...
}, ef = null, pi = null, yc = function t(e) {
  if (e === ef && Array.isArray(pi))
    return pi;
  var r = [];
...
var tf = function(e) {
  ...
  if (n === 0)
    return !0;
  if (n === 1)
    return rf(Array.isArray(e) ? e[0] : e, Array.isArray(r) ? r[0] : r);
  for (var a = 0; a < n; a++) {
    var i = e[a], o = r[a];
  ...
  if (H(e) && H(r))
    return !0;
  if (!H(e) && !H(r)) {
    var n = e.props || {}, a = n.children, i = Jl(n, kb), o = r.props || {}, u = o.children, s = Jl(o, Lb);
...
var ey = {
  ...
  var r = e.type, n = r === void 0 ? "circle" : r, a = e.size, i = a === void 0 ? 64 : a, o = e.sizeType, u = o === void 0 ? "area" : o, s = j0(e, P0), c = vf(vf({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), f = function() {
...
var kO = BO();
const Rp = /* @__PURE__ */ J(kO);
function my(t, e, r) {
  return e === !0 ? Rp(t, r) : U(e) ? Rp(t, e) : t;
}
function It(t) {
  "@babel/helpers - typeof";
...
function WO(t, e, r) {
  return e && qp(t.prototype, e), r && qp(t, r), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function zO(t, e, r) {
...
var Np = 1, _t = /* @__PURE__ */ (function(t) {
  function e() {
    var r;
    FO(this, e);
  ...
  return HO(e, t), WO(e, [{
    ...
    value: function() {
      ...
      a ? (Math.abs(a.width - this.lastBoundingBox.width) > Np || Math.abs(a.height - this.lastBoundingBox.height) > Np) && (this.lastBoundingBox.width = a.width, this.lastBoundingBox.height = a.height, n && n(a)) : (this.lastBoundingBox.width !== -1 || this.lastBoundingBox.height !== -1) && (this.lastBoundingBox.width = -1, this.lastBoundingBox.height = -1, n && n(null));
    }
  }, {
    key: "getBBoxSnapshot",
    value: function() {
...
function mw(t, e) {
  if (t) {
    ...
    if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return od(t, e);
  }
}
function od(t, e) {
...
function Iw(t) {
  ...
  return o.height > 0 && o.width > 0 && r ? (f = sd({
...
var fd = 1, kw = /* @__PURE__ */ (function(t) {
  function e() {
    var r;
    Mw(this, e);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
  ...
  return Nw(e, t), $w(e, [{
    ...
    value: function() {
      if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
        var n = this.wrapperNode.getBoundingClientRect();
        (Math.abs(n.width - this.state.lastBoundingBox.width) > fd || Math.abs(n.height - this.state.lastBoundingBox.height) > fd) && this.setState({
          lastBoundingBox: {
            width: n.width,
            height: n.height
          }
    ...
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, f = a.coordinate, l = a.hasPayload, p = a.isAnimationActive, v = a.offset, m = a.position, h = a.reverseDirection, d = a.useTranslate3d, g = a.viewBox, O = a.wrapperStyle, w = Iw({
        ...
        useTranslate3d: d,
        viewBox: g
      }), S = w.cssClasses, y = w.cssProperties, b = ld(ld({
...
var Ad = function(e) {
  ...
  try {
    ...
    i || (i = document.createElement("span"), i.setAttribute("id", Sd), i.setAttribute("aria-hidden", "true"), document.body.appendChild(i));
    var o = gs(gs({}, yx), n);
...
function Ax(t, e, r) {
  return e && _d(t.prototype, e), r && _d(t, r), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function Px(t) {
  var e = _x(t, "string");
...
var Ed = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, Td = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, Ex = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, Tx = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, My = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
...
function Cy(t) {
  ...
  for (var e = t; e.includes("*") || e.includes("/"); ) {
    var r, n = (r = Ed.exec(e)) !== null && r !== void 0 ? r : [], a = fn(n, 4), i = a[1], o = a[2], u = a[3], s = Yr.parse(i ?? ""), c = Yr.parse(u ?? ""), f = o === "*" ? s.multiply(c) : s.divide(c);
    if (f.isNaN())
      return At;
    e = e.replace(Ed, f.toString());
  }
  for (; e.includes("+") || /.-\d+(?:\.\d+)?/.test(e); ) {
    var l, p = (l = Td.exec(e)) !== null && l !== void 0 ? l : [], v = fn(p, 4), m = v[1], h = v[2], d = v[3], g = Yr.parse(m ?? ""), O = Yr.parse(d ?? ""), w = h === "+" ? g.add(O) : g.subtract(O);
    if (w.isNaN())
      return At;
    e = e.replace(Td, w.toString());
  }
  return e;
}
var jd = /\(([^()]*)\)/;
function Mx(t) {
  for (var e = t; e.includes("("); ) {
    var r = jd.exec(e), n = fn(r, 2), a = n[1];
    e = e.replace(jd, Cy(a));
  }
  return e;
}
...
var $y = /[ \f\n\r\t\v\u2028\u2029]+/, Ry = function(e) {
  ...
  for (var h = "…", d = function(C) {
    ...
    var y = Math.floor((g + O) / 2), b = y - 1, x = d(b), A = Md(x, 2), P = A[0], I = A[1], _ = d(y), T = Md(_, 1), M = T[0];
  ...
  return $d(a);
}, Rd = "#808080", Os = function(e) {
  var r = e.x, n = r === void 0 ? 0 : r, a = e.y, i = a === void 0 ? 0 : a, o = e.lineHeight, u = o === void 0 ? "1em" : o, s = e.capHeight, c = s === void 0 ? "0.71em" : s, f = e.scaleToFit, l = f === void 0 ? !1 : f, p = e.textAnchor, v = p === void 0 ? "start" : p, m = e.verticalAnchor, h = m === void 0 ? "end" : m, d = e.fill, g = d === void 0 ? Rd : d, O = Id(e, Rx), w = q.useMemo(function() {
    return Wx({
      breakAll: O.breakAll,
      children: O.children,
      maxLines: O.maxLines,
  ...
  }, [O.breakAll, O.children, O.maxLines, l, O.style, O.width]), S = O.dx, y = O.dy, b = O.angle, x = O.className, A = O.breakAll, P = Id(O, Dx);
  if (!ce(n) || !ce(i))
    return null;
...
function Kx(t, e, r) {
  if (t = Float64Array.from(Pg(t)), !(!(n = t.length) || isNaN(e = +e))) {
    if (e <= 0 || n < 2) return qd(t);
    if (e >= 1) return Dd(t);
    var n, a = (n - 1) * e, i = Math.floor(a), o = Dd(qy(t, i).subarray(0, i + 1)), u = qd(t.subarray(i + 1));
    return o + (u - o) * (a - i);
  }
}
      ...
      value: function() {
        ...
        if (I)
          return /* @__PURE__ */ E.createElement(wh, {
            ...
            title: _,
            desc: T
          }), this.renderClipPath(), nf(y, this.renderMap)));
        if (this.props.accessibilityLayer) {
          var C, R;
        ...
        return /* @__PURE__ */ E.createElement(wh, {
          ...
          desc: T,
          style: oj
        }), this.renderClipPath(), nf(y, this.renderMap)), this.renderLegend(), this.renderTooltip()));
      }
    }]);
  })(q.Component);
