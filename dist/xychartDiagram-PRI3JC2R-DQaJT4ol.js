import { s as gi, g as xi, t as Xt, q as di, a as pi, b as fi, _ as n, l as Nt, K as yi, e as mi, z as bi, H as Ct, i as Ai, F as Yt, G as wi, M as Ci, N as Si } from "./mermaid.core-OTEtjmZQ.js";
import { b as Bt } from "./band-DjWPbnU2.js";
import { l as Wt } from "./linear-C3c8AqSq.js";
import { l as zt } from "./string-psbzTrf6.js";
var mt = (function() {
...
var j, Ht = (j = class {
...
}, n(j, "TextDimensionCalculatorWithFont"), j), Ft = 0.7, Ot = 0.2, Q, Ut = (Q = class {
  constructor(t, i, e, a) {
  ...
  recalculateScale() {
    this.scale = Bt().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5), Nt.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
}, n(at, "XYChartBuilder"), at), ot = 0, Gt, rt = Tt(), ht = kt(), y = Rt(), wt = ht.plotColorPalette.split(",").map((s) => s.trim()), gt = !1, _t = !1;
function kt() {
  const s = Ci(), t = Ct();
  return Yt(s.xyChart, t.themeVariables.xyChart);
}
...
function ii(s) {
  const t = Math.min(...s), i = Math.max(...s), e = G(y.yAxis) ? y.yAxis.min : 1 / 0, a = G(y.yAxis) ? y.yAxis.max : -1 / 0;
  y.yAxis = {
    type: "linear",
    title: y.yAxis.title,
    min: Math.min(e, t),
...
function vt(s) {
  ...
  if (s.length === 0)
    return t;
  if (!gt) {
    const i = G(y.xAxis) ? y.xAxis.min : 1 / 0, e = G(y.xAxis) ? y.xAxis.max : -1 / 0;
    Dt(Math.min(i, 1), Math.max(e, s.length));
  }
  if (_t || ii(s), St(y.xAxis) && (t = y.xAxis.categories.map((i, e) => [i, s[e]])), G(y.xAxis)) {
...
function ai() {
  ...
  return y.title = Xt(), Ei.build(rt, y, ht, Gt);
}
...
var Ii = /* @__PURE__ */ n(function() {
  ...
  n(I, "getTextTransformation"), Nt.debug(`Rendering xychart chart
` + s);
