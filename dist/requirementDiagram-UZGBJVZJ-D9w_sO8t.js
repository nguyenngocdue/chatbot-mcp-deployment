import { g as ze } from "./chunk-55IACEB6-uAaL20b5.js";
import { s as Ge } from "./chunk-QN33PNHL-DG34t4PC.js";
import { _ as f, b as Xe, a as Je, s as Ze, g as et, q as tt, t as st, c as Ne, l as qe, z as it, D as rt, p as nt, r as at, u as lt } from "./mermaid.core-BXO_VlFI.js";
var Ae = (function() {
  var e = /* @__PURE__ */ f(function(P, i, n, c) {
    ...
    parse: /* @__PURE__ */ f(function(i) {
      var n = this, c = [0], s = [], E = [null], t = [], Ee = this.table, a = "", ye = 0, Pe = 0, He = 2, $e = 1, Ke = t.slice.call(arguments, 1), g = Object.create(this.lexer), z = { yy: {} };
      for (var Ie in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Ie) && (z.yy[Ie] = this.yy[Ie]);
      g.setInput(i, z.yy), z.yy.lexer = g, z.yy.parser = this, typeof g.yylloc > "u" && (g.yylloc = {});
      var be = g.yylloc;
      t.push(be);
      ...
      f(Ue, "lex");
      for (var S, G, k, Te, J = {}, ge, F, Ye, _e; ; ) {
        if (G = c[c.length - 1], this.defaultActions[G] ? k = this.defaultActions[G] : ((S === null || typeof S > "u") && (S = Ue()), k = Ee[G] && Ee[G][S]), typeof k > "u" || !k.length || !k[0]) {
          var ke = "";
          _e = [];
          for (ge in Ee[G])
...
var ft = /* @__PURE__ */ f(async function(e, l, u, h) {
  ...
  const { securityLevel: r, state: o, layout: m } = Ne(), y = h.db.getData(), _ = ze(l, r);
  ...
  ), Ge(_, b, "requirementDiagram", o?.useMaxWidth ?? !0);
}, "draw"), pt = {
  parser: ct,
  get db() {
    return new ot();
