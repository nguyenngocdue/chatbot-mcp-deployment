import { _ as s, c as xt, l as E, d as j, W as kt, X as vt, Y as _t, $ as bt, D as wt, a0 as St, z as Et } from "./mermaid.core-BXO_VlFI.js";
import { d as nt } from "./arc-y4x8g4Cx.js";
var Q = (function() {
  var n = /* @__PURE__ */ s(function(x, r, a, c) {
    ...
    parse: /* @__PURE__ */ s(function(r) {
      ...
      var $ = g.yylloc;
      o.push($);
      var V = g.options && g.options.ranges;
...
var zt = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), x && x.length > 0 ? x.forEach((H) => {
    const g = k.filter((V) => V.section === H), b = {
      number: w,
      descr: H,
      section: w,
