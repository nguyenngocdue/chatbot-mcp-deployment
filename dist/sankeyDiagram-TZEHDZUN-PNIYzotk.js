import { q as _t, t as xt, s as vt, g as bt, b as wt, a as St, _ as g, c as lt, A as Lt, d as H, W as Et, z as At, k as Tt } from "./mermaid.core-C8MeWhuc.js";
import { o as Mt } from "./ordinal-e--sRYe8.js";
function Nt(t) {
...
ot.prototype = kt.prototype = {
  ...
  arcTo: function(t, e, i, a, h) {
    ...
    if (this._x1 === null)
      ...
      Math.abs(D - 1) > V && (this._ += "L" + (t + D * o) + "," + (e + D * l)), this._ += "A" + h + "," + h + ",0,0," + +(l * x > o * y) + "," + (this._x1 = t + R * k) + "," + (this._y1 = e + R * s);
    }
  },
