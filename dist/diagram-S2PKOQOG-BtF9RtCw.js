import { _ as b, F as m, K as B, e as C, l as w, b as S, a as D, q as T, t as z, g as F, s as P, G as E, H as A, z as W } from "./mermaid.core-v6Q0JMw7.js";
import { p as _ } from "./chunk-4BX2VUAB-DINHr4uh.js";
import { p as N } from "./treemap-KMMF4GRG-awaFh3V8.js";
var L = E.packet, u, v = (u = class {
  constructor() {
  ...
  for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
    ...
    for (i ??= a + (d ?? 1) - 1, d ??= i - a + 1, r = i, w.debug(`Packet block ${a} - ${r} with label ${c}`); s.length <= l + 1 && t.getPacket().length < M; ) {
      const [p, o] = G({ start: a, end: i, bits: d, label: c }, n, l);
...
}, "draw"), I = /* @__PURE__ */ b((e, t, r, { rowHeight: s, paddingX: n, paddingY: l, bitWidth: a, bitsPerRow: i, showBits: d }) => {
