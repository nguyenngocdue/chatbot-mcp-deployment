import { o as S, q as p, r as w, u as k, v as q } from "./string-BnSFgVSn.js";
import { i as D } from "./init-DxzjmxYy.js";
...
function an(n, r, t, e) {
  ...
  switch (e = F(e ?? ",f"), e.type) {
    case "s": {
      ...
      return e.precision == null && !isNaN(f = tn(u, a)) && (e.precision = f), z(e, a);
    }
    case "":
    case "e":
    case "g":
