import { _ as o, l as te, c as H, K as fe, a1 as ye, a2 as be, a3 as me, W as _e, G as K, i as j, v as Ee, J as ke, X as Se, Y as ce, $ as le } from "./mermaid.core-BXO_VlFI.js";
import { g as Ne } from "./chunk-FMBD7UC4-GfrOBHWo.js";
var $ = (function() {
  var e = /* @__PURE__ */ o(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), u = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], E = [1, 16], b = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], _ = [6, 7, 11], F = [1, 31], N = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], m = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], M = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(i, n, r, a, h, t, U) {
      var c = t.length - 1;
      switch (h) {
        case 6:
        case 7:
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var n = this, r = [0], a = [], h = [null], t = [], U = this.table, c = "", W = 0, se = 0, ue = 2, re = 1, ge = t.slice.call(arguments, 1), y = Object.create(this.lexer), R = { yy: {} };
      ...
      o(ae, "lex");
      for (var k, P, x, Q, G = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((k === null || typeof k > "u") && (k = ae()), x = U[P] && U[P][k]), typeof x > "u" || !x.length || !x[0]) {
          var Z = "";
          X = [];
          for (z in U[P])
        ...
        switch (x[0]) {
          ...
          case 2:
            if (C = this.productions_[x[1]][1], G.$ = h[h.length - C], G._$ = {
              ...
              return Q;
            C && (r = r.slice(0, -1 * C * 2), h = h.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), h.push(G.$), t.push(G._$), oe = U[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
...
` + e);
  ...
  for (const m of g) {
    const A = F[V];
    V = V + 1;
    const L = b?.kanban?.sectionWidth || 200, M = -L * 3 / 2 + N;
    let T = M;
    ...
    const B = A.cluster.select("rect"), O = Math.max(T - M + 3 * _, 50) + (N - 25);
    B.attr("height", O);
  }
  _e(
    void 0,
