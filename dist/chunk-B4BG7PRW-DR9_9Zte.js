import { g as et } from "./chunk-FMBD7UC4-C_yXWO3E.js";
import { g as tt } from "./chunk-55IACEB6-CW8F_XEN.js";
import { s as st } from "./chunk-QN33PNHL-CSgmD0-9.js";
import { _ as A, l as Oe, c as D, p as it, r as at, u as we, d as ee, b as nt, a as rt, s as ut, g as lt, q as ct, t as ot, k as v, z as ht, y as dt, i as pt, T as R } from "./mermaid.core-OTEtjmZQ.js";
var Ve = (function() {
  var s = /* @__PURE__ */ A(function(I, c, o, d) {
    for (o = o || {}, d = I.length; d--; o[I[d]] = c) ;
    return o;
    ...
    performAction: /* @__PURE__ */ A(function(c, o, d, r, g, e, $) {
      var t = e.length - 1;
      switch (g) {
        case 8:
          this.$ = e[t - 1];
    ...
    parseError: /* @__PURE__ */ A(function(c, o) {
      if (o.recoverable)
        this.trace(c);
      else {
        var d = new Error(c);
    ...
    parse: /* @__PURE__ */ A(function(c) {
      var o = this, d = [0], r = [], g = [null], e = [], $ = this.table, t = "", oe = 0, ze = 0, He = 2, Ke = 1, Je = e.slice.call(arguments, 1), k = Object.create(this.lexer), O = { yy: {} };
      ...
      function Ye() {
        var _;
        return _ = r.pop() || k.lex() || Ke, typeof _ != "number" && (_ instanceof Array && (r = _, _ = r.pop()), _ = o.symbols_[_] || _), _;
      }
      A(Ye, "lex");
...
` + k.showPosition() + `
Expecting ` + de.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : Ie = "Parse error on line " + (oe + 1) + ": Unexpected " + (F == Ke ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(Ie, {
            text: k.match,
        ...
        switch (S[0]) {
          case 1:
            d.push(F), g.push(k.yytext), e.push(k.yylloc), d.push(S[1]), F = null, ze = k.yyleng, t = k.yytext, oe = k.yylineno, xe = k.yylloc;
            break;
          case 2:
    ...
    var I = {
      EOF: 1,
      parseError: /* @__PURE__ */ A(function(o, d) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ A(function(c, o) {
      ...
      unput: /* @__PURE__ */ A(function(c) {
        ...
        return this.yylloc = {
          ...
          last_column: d ? (d.length === r.length ? this.yylloc.first_column : 0) + r[r.length - d.length].length - d[0].length : this.yylloc.first_column - o
...
` + o + "^";
      ...
      test_match: /* @__PURE__ */ A(function(c, o) {
        var d, r, g;
        ...
        }, this.options.ranges && (g.yylloc.range = this.yylloc.range.slice(0))), r = c[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: r ? r[r.length - 1].length - r[r.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + c[0].length
        }, this.yytext += c[0], this.match += c[0], this.matches = c, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(c[0].length), this.matched += c[0], d = this.performAction.call(this, this.yy, this, o, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), d)
          return d;
        if (this._backtrack) {
          for (var e in g)
            this[e] = g[e];
      ...
      next: /* @__PURE__ */ A(function() {
        ...
        for (var g = this._currentRules(), e = 0; e < g.length; e++)
          if (d = this._input.match(this.rules[g[e]]), d && (!o || d[0].length > o[0].length)) {
            if (o = d, r = e, this.options.backtrack_lexer) {
              if (c = this.test_match(d, g[e]), c !== !1)
                return c;
              if (this._backtrack) {
                o = !1;
                continue;
        ...
        return o ? (c = this.test_match(o, g[r]), c !== !1 ? c : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ A(function(o, d, r, g) {
        switch (r) {
          case 0:
            return 62;
          case 1:
  ...
  return A(ce, "Parser"), ce.prototype = Ne, Ne.Parser = ce, new ce();
})();
Ve.parser = Ve;
