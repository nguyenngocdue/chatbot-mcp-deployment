import { x as S, y as p, z as w, A as k, B as q } from "./string-psbzTrf6.js";
import { i as z } from "./init-DxzjmxYy.js";
import { e as g, f as B, a as D, b as F } from "./defaultLocale-BgPVtth8.js";
function M(n, r) {
...
function R(n) {
  let r, t, e;
  n.length !== 2 ? (r = M, t = (o, c) => M(n(o), c), e = (o, c) => n(o) - c) : (r = n === M || n === x ? n : I, t = n, e = n);
...
function N(n, r) {
  var t = typeof r, e;
  return r == null || t === "boolean" ? S(r) : (t === "number" ? p : t === "string" ? (e = w(r)) ? (r = e, k) : q : r instanceof w ? k : r instanceof Date ? L : J(r) ? H : Array.isArray(r) ? K : typeof r.valueOf != "function" && typeof r.toString != "function" || isNaN(r) ? Q : p)(n, r);
}
function U(n, r) {
...
function nn() {
  ...
  function h() {
    ...
    return a !== m && (a = Y(n[0], n[s - 1])), o = s > 2 ? _ : Z, c = i = null, l;
  }
  function l(s) {
...
function an(n, r, t, e) {
  var u = G(n, r, t), f;
  switch (e = B(e ?? ",f"), e.type) {
    case "s": {
      var a = Math.max(Math.abs(n), Math.abs(r));
      return e.precision == null && !isNaN(f = tn(u, a)) && (e.precision = f), D(e, a);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      e.precision == null && !isNaN(f = un(u, Math.max(Math.abs(n), Math.abs(r)))) && (e.precision = f - (e.type === "e"));
      break;
    }
    case "f":
    case "%": {
      e.precision == null && !isNaN(f = en(u)) && (e.precision = f - (e.type === "%") * 2);
      break;
    }
  }
  return F(e);
